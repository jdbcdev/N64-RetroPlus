...
extern "C" DECLSPEC void SDLCALL Java_es_jdbc_n64retroplus_jni_NativeExports_loadLibraries(JNIEnv* env, jclass cls, jstring jlibPath)
{
...
extern "C" DECLSPEC void SDLCALL Java_es_jdbc_n64retroplus_jni_NativeExports_unloadLibraries(JNIEnv* env, jclass cls)
{
...
extern "C" DECLSPEC void SDLCALL Java_es_jdbc_n64retroplus_jni_NativeExports_emuStart(JNIEnv* env, jclass cls, jstring juserDataPath, jstring juserCachePath, jobjectArray jargv)
{
    ...
    jclass nativeImports = env->FindClass("es/jdbc/n64retroplus/jni/NativeImports");
    jclass nativeSDL = env->FindClass("es/jdbc/n64retroplus/jni/NativeSDL");
...
extern "C" DECLSPEC void Java_es_jdbc_n64retroplus_jni_NativeExports_emuStop(JNIEnv* env, jclass cls)
{
    if (coreDoCommand) coreDoCommand(M64CMD_STOP, 0, NULL);
}

extern "C" DECLSPEC void Java_es_jdbc_n64retroplus_jni_NativeExports_emuResume(JNIEnv* env, jclass cls)
{
    if (coreDoCommand) coreDoCommand(M64CMD_RESUME, 0, NULL);
}

extern "C" DECLSPEC void Java_es_jdbc_n64retroplus_jni_NativeExports_emuPause(JNIEnv* env, jclass cls)
{
    if (coreDoCommand) coreDoCommand(M64CMD_PAUSE, 0, NULL);
}

extern "C" DECLSPEC void Java_es_jdbc_n64retroplus_jni_NativeExports_emuAdvanceFrame(JNIEnv* env, jclass cls)
{
    if (coreDoCommand) coreDoCommand(M64CMD_ADVANCE_FRAME, 0, NULL);
}

extern "C" DECLSPEC void Java_es_jdbc_n64retroplus_jni_NativeExports_emuSetSpeed(JNIEnv* env, jclass cls, jint percent)
{
    int speed_factor = (int) percent;
    if (coreDoCommand) coreDoCommand(M64CMD_CORE_STATE_SET, M64CORE_SPEED_FACTOR, &speed_factor);
}

extern "C" DECLSPEC void Java_es_jdbc_n64retroplus_jni_NativeExports_emuSetFramelimiter(JNIEnv* env, jclass cls, jboolean enabled)
{
    int e = enabled == JNI_TRUE ? 1 : 0;
    if (coreDoCommand) coreDoCommand(M64CMD_CORE_STATE_SET, M64CORE_SPEED_LIMITER, &e);
}

extern "C" DECLSPEC void Java_es_jdbc_n64retroplus_jni_NativeExports_emuSetSlot(JNIEnv* env, jclass cls, jint slotID)
{
    if (coreDoCommand) coreDoCommand(M64CMD_STATE_SET_SLOT, (int) slotID, NULL);
}

extern "C" DECLSPEC void Java_es_jdbc_n64retroplus_jni_NativeExports_emuLoadSlot(JNIEnv* env, jclass cls)
{
    if (coreDoCommand) coreDoCommand(M64CMD_STATE_LOAD, 0, NULL);
}

extern "C" DECLSPEC void Java_es_jdbc_n64retroplus_jni_NativeExports_emuSaveSlot(JNIEnv* env, jclass cls)
{
    if (coreDoCommand) coreDoCommand(M64CMD_STATE_SAVE, 1, NULL);
}

extern "C" DECLSPEC void Java_es_jdbc_n64retroplus_jni_NativeExports_emuLoadFile(JNIEnv* env, jclass cls, jstring filename)
{
...
extern "C" DECLSPEC void Java_es_jdbc_n64retroplus_jni_NativeExports_emuSaveFile(JNIEnv* env, jclass cls, jstring filename)
{
    const char *nativeString = env->GetStringUTFChars(filename, 0);
...
extern "C" DECLSPEC void Java_es_jdbc_n64retroplus_jni_NativeExports_emuScreenshot(JNIEnv* env, jclass cls)
{
    if (coreDoCommand) coreDoCommand(M64CMD_TAKE_NEXT_SCREENSHOT, 0, NULL);
}

extern "C" DECLSPEC void Java_es_jdbc_n64retroplus_jni_NativeExports_emuGameShark(JNIEnv* env, jclass cls, jboolean pressed)
{
    int p = pressed == JNI_TRUE ? 1 : 0;
    if (coreDoCommand) coreDoCommand(M64CMD_CORE_STATE_SET, M64CORE_INPUT_GAMESHARK, &p);
}

extern "C" DECLSPEC jint Java_es_jdbc_n64retroplus_jni_NativeExports_emuGetState(JNIEnv* env, jclass cls)
{
    int state = 0;
...
extern "C" DECLSPEC jint Java_es_jdbc_n64retroplus_jni_NativeExports_emuGetSpeed(JNIEnv* env, jclass cls)
{
    int speed = 100;
...
extern "C" DECLSPEC jboolean Java_es_jdbc_n64retroplus_jni_NativeExports_emuGetFramelimiter(JNIEnv* env, jclass cls)
{
    int e = 1;
...
extern "C" DECLSPEC jint Java_es_jdbc_n64retroplus_jni_NativeExports_emuGetSlot(JNIEnv* env, jclass cls)
{
    int slot = 0;
