...
JNIEXPORT void JNICALL Java_es_jdbc_n64retroplus_jni_NativeInput_init(JNIEnv* env, jclass cls, jobject obj)
{
...
JNIEXPORT void JNICALL Java_es_jdbc_n64retroplus_jni_NativeInput_setConfig(JNIEnv* env, jclass jcls, jint controllerNum, jboolean plugged,
        jint pakType)
{
...
JNIEXPORT void JNICALL Java_es_jdbc_n64retroplus_jni_NativeInput_setState(JNIEnv* env, jclass jcls, jint controllerNum, jbooleanArray mp64pButtons,
