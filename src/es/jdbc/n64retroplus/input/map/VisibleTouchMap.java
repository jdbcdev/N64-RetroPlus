...
public class VisibleTouchMap extends TouchMap
{
     ...
     * (non-Javadoc)
     * 
     * @see es.jdbc.n64retroplus.input.map.TouchMap#clear()
     */
    @Override
    public void clear()
    {
     ...
     * (non-Javadoc)
     * 
     * @see es.jdbc.n64retroplusinput.map.TouchMap#resize(int, int)
     */
    @Override
     ...
     * 
     * @see
     * es.jdbc.n64retroplusinput.map.TouchMap#loadAllAssets(paulscode.android.mupen64plusae
     ...
     * (non-Javadoc)
     * 
     * @see es.jdbc.n64retroplusinput.map.TouchMap#loadAssetSection(java.lang.String,
     * java.lang.String, es.jdbc.n64retropluspersistent.ConfigFile.ConfigSection,
     * java.lang.String)
     */
    @Override
